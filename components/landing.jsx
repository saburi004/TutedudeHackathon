          ...
          <div className="relative">
            ...
            >
              <div className="flex items-center space-x-3 text-white">
                ...
                <span className="text-white">Start Supplying</span>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-teal-200/50 hover:border-teal-300/80 transition-all duration-500 hover:transform hover:-translate-y-2 hover:shadow-2xl shadow-lg"
              >
                ...
                <p className="text-slate-600 group-hover:text-slate-700 transition-opacity duration-300">
                  {feature.description}
                </p>

                {/* Hover Glow Effect */}
                <div className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${feature.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300 blur-xl`}></div>
              </div>
            ))}
          </div>
        </div>
