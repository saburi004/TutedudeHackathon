  ...
  return (
    <div className="p-6">
      ...
      <div className="space-y-6">
        {files.map((file) => (
          <div key={file.id} className="bg-white p-4 rounded-lg shadow-md flex justify-between items-center">
      ...
      {showVerificationModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg max-w-md w-full">
            <h2 className="text-xl font-bold mb-4">Submit for Verification</h2>
            <p className="mb-6">
